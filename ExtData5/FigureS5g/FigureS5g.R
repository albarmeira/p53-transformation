#FigureS5d - Greenleaf-derived erythroid signatures in BeatAML dataset (all AMLs)
...
# Boxplot
    ...
    # Save file
    ggsave(file="FigureS5g.png", width=2, height=4)

# Statistical test
wilcox.test(y~x)$p.value #0.0002102624
