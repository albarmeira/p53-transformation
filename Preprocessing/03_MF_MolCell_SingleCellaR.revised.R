...
add_cell_cycle_genes_score(MF_MolCell,gmt.file = paste(path.dropbox,"SingleCellaR.0.1.4/Data/genesets/MC.human.signature.genes.gmt",sep=""))
...
remove_unwanted_genes_from_variable_gene_set(MF_MolCell,gmt.file = paste(path.dropbox,"SingleCellaR.0.1.4/Data/genesets/human.signature.genes.gmt",sep=""),
...
plot_umap_label_by_multiple_gene_sets(MF_MolCell,gmt.file = paste(path.dropbox,"SingleCellaR.0.1.4/Data/genesets/MC.human.signature.genes.gmt",sep=""),
